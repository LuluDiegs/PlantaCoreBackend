...
public class AccountReactivationService : IAccountReactivationService
{
    ...
    private readonly ILogger<AccountReactivationService> _logger;
    ...
    public AccountReactivationService(
        ...
        ILogger<AccountReactivationService> logger,
    ...
    public async Task<Resultado> SolicitarReativacaoAsync(string email)
    {
        ...
        catch (Exception ex)
        {
            ...
            return Resultado.Erro("Erro ao solicitar reativação. Tente novamente.");
        }
    }
    ...
    public async Task<Resultado> ReativarComTokenAsync(string email, string token, string novaSenha)
    {
        ...
        {
            _logger.LogError(ex, "Erro ao reativar conta");
            return Resultado.Erro("Erro ao reativar conta. Tente novamente.");
        }
    }
    ...
    public async Task<Resultado> VerificarTokenReativacaoAsync(string email, string token)
    {
        ...
        {
            _logger.LogError(ex, "Erro ao verificar token de reativacao");
            return Resultado.Erro("Erro ao verificar token. Tente novamente.");
        }
    }
